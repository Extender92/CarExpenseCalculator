...
export const labels: Record<string, string> = {
  ...
  calculationPeriodMonths: "Äldre kalkylperiod (månader)",
  expectedResidualValueSek: "Äldre fast restvärde (kr)",
  vehicleTax: "Fordonsskatt",
  maintenanceAndRepairs: "Kombinerat äldre underhåll",
  otherRecurringCosts: "Äldre återkommande kostnader",
  otherOneTimeCosts: "Äldre engångskostnader",
